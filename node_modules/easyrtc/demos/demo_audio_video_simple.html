...
<html>
    <head>
        ...
        <title>Telstra MeetMe EasyRTC Demo: Audio and Video</title>
    ...
    <body onload="connect();">
        ...
        <div id="container">
            <div id="header">
                <div class="img"><img id="logo_easyrtc" src="images/MeetMe.png" alt="Telstra" style="" /></div>
                <!--<div class="text"><h1>Telstra MeetMe EasyRTC Demo: Audio and Video</h1></div>-->
            </div>

            <span style="display:inline-block;margin-left:200px"></span>
            ...
            <div id="main">
                ...
                <div id="demoContainer">
                    ...
                    <div id="videos">
                        ...
                        <div style="position:relative;float:left;">
                            <video autoplay="autoplay" class="easyrtcMirror"  id="callerVideo"></video>
                        </div>
               ...
               <!-- <h2>The Code</h2>
                ...
                &lt;!&ndash; Runs the SyntaxHighlighter &ndash;&gt;
